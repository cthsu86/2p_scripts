...
%     highAmplitudeFilter(aboveThreshIndices(freq_aboveThreshIndices)) = 0;
% 
%     P1(find(highAmplitudeFilter))=0;
%     filteredSignal = ifft(fftshift(P1));
end;
